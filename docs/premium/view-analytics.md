---
title: "View analytics for a job posting"
author: Catherine Dundon
tags: [premium, analytics, application, match, review, assistance]
published: true
---
...
1. After [finding a job listing](../apply/search-for-jobs.md), scroll down to find the job match prompt:
    ...
    ![job match prompt](../images/job-match.png)
...
![applicant data](../images/applicants.png)
...
![hiring trend](../images/hiring-trend.png)
